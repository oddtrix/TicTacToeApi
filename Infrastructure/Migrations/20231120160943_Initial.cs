    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldMoves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FieldMoves_Fields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FieldMovesId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PlayerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cells_FieldMoves_FieldMovesId",
                        column: x => x.FieldMovesId,
                        principalTable: "FieldMoves",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlayerJunction", x => x.Id);
                    table.ForeignKey(
